        ...
        <div className='w-full max-w-[800px] p-5 border-8 border-[#FDE5B6] flex flex-col justify-center items-center bg-[#1E5537]'>
            ...
            <div className='flex flex-col sm:flex-row gap-16 justify-center items-center mt-10'>
                ...
                <div className='flex flex-col items-center'>
                    <input type='number' placeholder='0.00' className=" w-full max-w-[140px] h-[35px] border-b-2 border-white bg-transparent text-white font-semibold focus:outline-none text-center" value={peso} onChange={(e) => setpeso(parseFloat(e.target.value) || 0)}/>
                    <h2 className="text-white font-semibold text-lg">Digite seu Peso</h2>
                </div>

                <div className='flex flex-col items-center'>
                    <input type='number'placeholder='0.00' className=" w-full max-w-[140px] h-[35px] border-b-2 border-white bg-transparent text-white font-semibold focus:outline-none text-center" value={altura} onChange={(e) => setaltura(parseFloat(e.target.value) || 0)}/>
